...
/*    public static ParentPost createPost(String text, boolean anonymous) throws InvalidPostException
    ...
    {
         return new ParentPost(genInt(), genInt(), genChildPosts(), genInt(), genInt(), genLocation(), genDate(), genPost(), genBoolean());
    }
    ...
    {
        return new ChildPost(genInt(), genInt(), genInt(), genLocation(), genDate(), genPost(), genBoolean());
    }
}
